...
You are a multilingual business analyst.
        ...
        full_prompt = f"""
You are a data analyst. Analyze the dataset below based on this question:
...
"""
        ...
        if chart_code:
            try:
                ...
                st.error("❌ Failed to run visualization code.")
                st.code(chart_code)
                st.exception(e)
        else:
            st.warning("⚠️ No visualization code found in Gemini output.")
